...
function Dumper(host, port, sslOptions) {
    // ETCD client
    this.store = new Etcd(host, port, sslOptions);
...
function createDumper(host, port, sslOptions) {
    return new Dumper(host, port, sslOptions);
}
